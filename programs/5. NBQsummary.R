...
load("D:/Course/BIOS7695/Final projects/data/dispersion1.rdata")
dispersion1<-x
load("D:/Course/BIOS7695/Final projects/data/dispersion2.RData")
dispersion2<-x
load("D:/Course/BIOS7695/Final projects/data/dispersion3.RData")
dispersion3<-x
load("D:/Course/BIOS7695/Final projects/data/dispersion4.RData")
dispersion4<-x
load("D:/Course/BIOS7695/Final projects/data/dispersion5.RData")
dispersion5<-x
...
#Summary the results
load("D:/Course/BIOS7695/Final projects/data/res1.rdata")
res1<-x
gene.id<-seq(1,3000)
...
load("D:/Course/BIOS7695/Final projects/data/res2.rdata")
res2<-x
...
load("D:/Course/BIOS7695/Final projects/data/res3.rdata")
res3<-x
...
load("D:/Course/BIOS7695/Final projects/data/res4.rdata")
res4<-x
...
load("D:/Course/BIOS7695/Final projects/data/res5.rdata")
res5<-x

...
write.csv(NB2glm.disp,'D:/Course/BIOS7695/Final projects/data/NB2glm.disp.csv')
write.csv(NB2glm.disp2,'D:/Course/BIOS7695/Final projects/data/NB2glm.disp.csv')
